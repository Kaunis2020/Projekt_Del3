<template>
    <div class="container-sm text-center">
        ...
        <br/>
        <br/>
        <FoodTable msg="kalla drycker"  negmsg="Inga drycker finns att visa"  :posts="posts"></FoodTable> 
        <br/>
    </div> 
    <br/>
    <br/>
    ...
    export default {
        ...
        methods: {
            ...
            async filterCategory($event) {
                const url = "http://localhost:3000/open/cold/";
            ...
            async filterPrice($event) {
                ...
                else
                {
                    ...
                    if (!isNaN(price)) {
                        const url = "http://localhost:3000/open/cold/price/";
