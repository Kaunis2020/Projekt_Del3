<template>
    <div class="container-sm text-center">
        ...
        <br/>
        <br/>
        <FoodTable msg="veganska maträtter"  negmsg="Inga maträtter finns att visa"  :posts="posts"></FoodTable>
        <br/>
    </div>
    <br/>
    <br/>
    ...
    export default {
        ...
        methods: {
            ...
            async filterCategory($event) {
                const url = "http://localhost:3000/open/vegan/";
            ...
            async filterPrice($event) {
                ...
                else
                {
                    ...
                    if (!isNaN(price)) {
                        const url = "http://localhost:3000/open/vegan/price/";
