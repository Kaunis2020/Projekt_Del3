    ...
    <div class="container text-center">
        <div class="row justify-content-center">
            ...
            <form class="col-lg-6" v-on:submit.prevent="addUser">
                ...
                <div class="w-100 mb-3">
                    <label for="visitdate" class="form-label">Datum för besöket:</label><br/> 
                ...
                <div class="row text-center justify-content-center">
                    <div class="col-md-3">
                        <label for="selected" class="form-label">Bordsplacering:</label><br/> 
                        <select v-model="selected" class="form-select-lg px-3" id="filter" name="filter">
                            <option v-for="cat in cats" :value="cat" v-bind:key="cat">
                                {{ cat }}
                            </option>
                        </select>
                    </div>
...
<script>
    ...
    export default {
        name: 'TableOrder',
        setup() {
            const selected = ref("Välj ett bord här:");
            const cats = ref([
                "Välj ett bord här:",
                "Egen lounge",
                "Vid baren",
